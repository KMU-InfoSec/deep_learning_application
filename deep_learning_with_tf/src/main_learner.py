...
def run(model_dic):
    mal_data, ben_data, indices = split_train_test_data(CLASS_TYPE, mal_path=model_dic['mal_dir'], ben_path=model_dic['ben_dir'],
                                                        mal_train_start_date='20170802', mal_train_end_date='20170929',
...
def run_using_k_fold(model_dic):
...
if __name__ == '__main__':
    ...
    model_arg = {
        ...
        'fhs_flag': bool(config.get('BASIC_INFO', 'FHS_FLAG')),
